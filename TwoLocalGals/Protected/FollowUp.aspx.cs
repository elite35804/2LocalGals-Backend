...
namespace TwoLocalGals.Protected
{
    public partial class FollowUp : System.Web.UI.Page
    {
        ...
        private void LoadAppointment()
        {
            ...
            {
                AppStruct app;
                string error = Database.GetApointmentpByID(Globals.GetFranchiseMask(), Globals.SafeIntParse(Request["appID"]), out app);
                if (error != null)
                {
                ...
                {
                    FollowUpLegend.InnerText = "Service Follow Up for Customer (" + app.customerTitle + ") on (" + app.appointmentDate.ToString("dddd MM/dd/yyyy") + ")";
