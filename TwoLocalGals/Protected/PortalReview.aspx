<%@ Page Title="" Language="C#" MasterPageFile="~/CustomerPortal.Master" AutoEventWireup="true"
    CodeBehind="PortalReview.aspx.cs" Inherits="TwoLocalGals.Protected.PortalReview" %>
...
<asp:Content ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <title>2LG Appointment Review</title>
        <link href="/Styles/PortalReviewM.css" media="screen and (max-width: 800px)" rel="stylesheet"
        type="text/css" />
    <link href="/Styles/PortalReview.css" media="screen and (min-width: 800px)" rel="stylesheet"
        type="text/css" />
</asp:Content>
<asp:Content ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="ContentHolder">
        ...
        <table id="HousekeepingSection" class="Review" style="display:none;" runat="server">
			...
			<tr>
				<td colspan="2">
					<asp:TextBox ID="HK_Better" CssClass="ReviewTextBox" runat="server" Rows="4" TextMode="multiline" Width="480px" />
				</td>
			</tr>
		</table>
		<table id="CarpetCleaningSection" class="Review" style="display:none;" runat="server">
			...
			<tr>
				<td colspan="2">
					<asp:TextBox ID="CC_Better" CssClass="ReviewTextBox" runat="server" Rows="4" TextMode="multiline" Width="480px" />
				</td>
			</tr>
		</table>
		<table id="WindowWashingSection" class="Review" style="display:none;" runat="server">
			...
			<tr>
				<td colspan="2">
					<asp:TextBox ID="WW_Better" CssClass="ReviewTextBox" runat="server" Rows="4" TextMode="multiline" Width="480px" />
				</td>
			</tr>
		</table>
		<table id="HomewatchSection" class="Review" style="display:none;" runat="server">
			...
			<tr>
				<td colspan="2">
					<asp:TextBox ID="HW_Better" CssClass="ReviewTextBox" runat="server" Rows="4" TextMode="multiline" Width="480px" />
				</td>
			</tr>
		</table>
		<table class="Review">
            <tr>
                <td colspan="2">
                    <asp:Button ID="SubmitButton" CssClass="ReviewButton" OnClick="SubmitClick" Text="Submit" runat="server" />
                    <asp:Button ID="CancelButton" CssClass="ReviewButton" OnClick="CancelClick" Text="Cancel" runat="server" />
                </td>
            </tr>
        </table>
    </div>
